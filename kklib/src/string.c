...
kk_decl_export kk_string_t  kk_string_validate_mutf8(kk_string_t str, kk_context_t* ctx) {
  ...
  // it is already valid utf-8 which should be very common
  size_t len;
