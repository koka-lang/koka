// Koka generated module: handlers/basic/@main, koka version: 3.2.4
"use strict";
...
import * as $handlers_basic from './handlers_basic.mjs';
...
export function _expr() /* () -> <console/console,div> () */  {
  ...
  var x_10000 = $handlers_basic.main();
