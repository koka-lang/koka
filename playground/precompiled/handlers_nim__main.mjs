// Koka generated module: handlers/nim/@main, koka version: 3.2.4
"use strict";
...
import * as $handlers_nim from './handlers_nim.mjs';
...
export function _expr() /* () -> <pure,console/console> () */  {
  return $handlers_nim.main();
}
 
export function _main() /* () -> <st<global>,console/console,div,fsys,ndet,net,ui> () */  {
  return $std_core._default_exn($handlers_nim.main);
}
