...
Go to GitHub, make sure everything looks okay on the releases tab and then publish as latest or prerelease.

# Releasing the VS Code extension

If the extension has not changed since the last release, you do not need to publish it.
