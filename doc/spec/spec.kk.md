...
|~~~~~~~~~~~~~~~|~~~~~~~~|~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~|~~~~~~~~~~~~~~|
| _char_        | ::=    | ``'`` (_graphic_[``'`` &bar; ``\``]{.diff} &bar; _space_ &bar; _utf8_ &bar; _escape_) ``'``                  |              |
| _string_      | ::=    | ``"`` [_graphic_[``"`` &bar; ``\``]{.diff} &bar; _space_ &bar; _utf8_ &bar; _escape_]{.many} ``"``             |              |
|               | &bar;  | ``r`` [``#``]{.manyn} ``"`` _rawstring_~_n_~ ``"`` [``#``]{.manyn}  |  (n >= 0)            |                 
| _rawstring_~_n_~ | ::=    | [_any_]{.many}[[_any_]{.many} ``"`` [``#``]{.manyn} [_any_]{.many}]{.diff}                                                                                     |              |
| &nbsp;        |        |                                                                                                                           |              |
...
| &nbsp;     |        |                                         |                                     |
| _utf8_     | ::=    | _utf8valid_[_bidi_]{.diff}              |                                  |
