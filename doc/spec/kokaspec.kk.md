...
At this point there are no binary releases of Koka and you need to build the
compiler yourself. Fortunately, it has few dependencies and builds on most
common platforms, &eg; Windows, MacOSX, and Unix.
...
* There is an online tutorial on Koka at <http://www.rise4fun.com/koka/tutorial>
  which introduces the basics of Koka syntax and the type system.

* The documentation of the [standard libraries][stdlib].
...
characters. Moreover, the grammer is designed such that a lexical
