...
resolveHeapDivConstraint alwaysNoDiv tpHeap0 tpVal0 tpEff0 free ic
  = case expandSyn (icType ic) of -- expand here again (should never fail!) so we get skolem substitutions
