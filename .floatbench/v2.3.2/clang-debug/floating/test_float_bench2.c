...
kk_unit_t kk_test_float_bench2_k(kk_context_t* _ctx) { /* () -> bra () */ 
  ...
  kk_box_t _x1120;
  {
    ...
    kk_std_core_hnd__clause0 _match_1104 = kk_test_float_bench2__select_brara(h, _ctx); /*std/core/hnd/clause0<(),test/float/bench2/.hnd-bra,187,188>*/;
    {
      ...
      _x1120 = kk_function_call(kk_box_t, (kk_function_t, kk_std_core_hnd__marker, kk_std_core_hnd__ev, kk_context_t*), _fun_unbox_x878, (_fun_unbox_x878, m0, ev_788, _ctx)); /*1006*/
    }
  }
...
kk_integer_t kk_test_float_bench2_one__(kk_integer_t a, kk_context_t* _ctx) { /* (a : int) -> count int */ 
  kk_integer_t a0_735;
  kk_box_t _x1127 = kk_std_core_hnd__open_none0(kk_test_float_bench2_new_one___fun1128(a, _ctx), _ctx); /*1001*/
  ...
  kk_box_t _x1132;
  {
    ...
    kk_std_core_hnd__clause1 _match_1102 = kk_test_float_bench2__select_one(h, _ctx); /*std/core/hnd/clause1<int,int,test/float/bench2/.hnd-count,204,205>*/;
    {
      ...
      _x1132 = kk_function_call(kk_box_t, (kk_function_t, kk_std_core_hnd__marker, kk_std_core_hnd__ev, kk_box_t, kk_context_t*), _fun_unbox_x895, (_fun_unbox_x895, m0, ev_793, kk_integer_box(a0_735), _ctx)); /*1011*/
    }
  }
...
kk_integer_t kk_test_float_bench2_two__(kk_integer_t a, kk_context_t* _ctx) { /* (a : int) -> count int */ 
  kk_integer_t a0_736;
  kk_box_t _x1139 = kk_std_core_hnd__open_none0(kk_test_float_bench2_new_two___fun1140(a, _ctx), _ctx); /*1001*/
  ...
  kk_box_t _x1144;
  {
    ...
    kk_std_core_hnd__clause1 _match_1100 = kk_test_float_bench2__select_two(h, _ctx); /*std/core/hnd/clause1<int,int,test/float/bench2/.hnd-count,221,222>*/;
    {
      ...
      _x1144 = kk_function_call(kk_box_t, (kk_function_t, kk_std_core_hnd__marker, kk_std_core_hnd__ev, kk_box_t, kk_context_t*), _fun_unbox_x913, (_fun_unbox_x913, m0, ev_799, kk_integer_box(a0_736), _ctx)); /*1011*/
    }
  }
...
kk_integer_t kk_test_float_bench2__mlift773_f(kk_ref_t c, kk_ref_t i, kk_integer_t _y_749, kk_context_t* _ctx) { /* forall<h> (c : local-var<h,int>, i : local-var<h,int>, int) -> <local<h>,bra,div> int */ 
  ...
  if (kk_yielding(kk_context())) {
    _x1148 = kk_std_core_hnd_yield_extend(kk_test_float_bench2__new_mlift773_f_fun1149(i, _ctx), _ctx); /*1002*/
  }
  else {
    _x1148 = (kk_ref_get(i,kk_context())); /*1002*/
  }
...
kk_integer_t kk_test_float_bench2__mlift774_f(kk_ref_t c, kk_ref_t i, kk_unit_t wild__, kk_context_t* _ctx) { /* forall<h> (c : local-var<h,int>, i : local-var<h,int>, wild_ : ()) -> <local<h>,bra,div> int */ 
  ...
  if (kk_yielding(kk_context())) {
    ...
    kk_box_t _x1152 = kk_std_core_hnd_yield_extend(kk_test_float_bench2__new_mlift774_f_fun1153(c, i, _ctx), _ctx); /*1002*/
...
kk_integer_t kk_test_float_bench2__mlift776_f(kk_ref_t c, kk_ref_t i, kk_integer_t _y_753, kk_context_t* _ctx) { /* forall<h> (c : local-var<h,int>, i : local-var<h,int>, int) -> <local<h>,bra,div> int */ 
  ...
  kk_box_t _x1157;
  if (kk_yielding(kk_context())) {
    _x1157 = kk_std_core_hnd_yield_extend(kk_test_float_bench2__new_mlift776_f_fun1158(i, _ctx), _ctx); /*1002*/
  }
  else {
    _x1157 = (kk_ref_get(i,kk_context())); /*1002*/
  }
...
kk_integer_t kk_test_float_bench2__mlift777_f(kk_ref_t c, kk_ref_t i, kk_unit_t wild__1, kk_context_t* _ctx) { /* forall<h> (c : local-var<h,int>, i : local-var<h,int>, wild_1 : ()) -> <local<h>,bra,div> int */ 
  ...
  _x1159 = (kk_ref_get(_x1160,kk_context())); /*1000*/
  x_812 = kk_integer_unbox(_x1159); /*int*/
  if (kk_yielding(kk_context())) {
    kk_integer_drop(x_812, _ctx);
    kk_box_t _x1161 = kk_std_core_hnd_yield_extend(kk_test_float_bench2__new_mlift777_f_fun1162(c, i, _ctx), _ctx); /*1002*/
...
kk_unit_t kk_test_float_bench2__mlift780_f(kk_integer_t a2, kk_context_t* _ctx) { /* (a2 : int) -> count () */ 
  ...
  if (kk_yielding(kk_context())) {
    kk_box_t _x1166 = kk_std_core_hnd_yield_extend(kk_test_float_bench2__new_mlift780_f_fun1167(_ctx), _ctx); /*1002*/
...
kk_unit_t kk_test_float_bench2__mlift781_f(kk_integer_t a1, kk_context_t* _ctx) { /* (a1 : int) -> count () */ 
  ...
  if (kk_yielding(kk_context())) {
    ...
    kk_box_t _x1170 = kk_std_core_hnd_yield_extend(kk_test_float_bench2__new_mlift781_f_fun1171(_ctx), _ctx); /*1002*/
...
static kk_box_t kk_test_float_bench2__mlift782_f_fun1175(kk_function_t _fself, kk_context_t* _ctx) {
  ...
  if (kk_yielding(kk_context())) {
    ...
    kk_box_t _x1177 = kk_std_core_hnd_yield_extend(kk_test_float_bench2__new_mlift782_f_fun1178(_ctx), _ctx); /*1002*/
...
kk_unit_t kk_test_float_bench2__mlift782_f(kk_integer_t a00, kk_context_t* _ctx) { /* forall<h> (a00 : int) -> <local<h>,count,bra,div> () */ 
  ...
  kk_box_t _x1174 = kk_std_core_hnd__open_at0(_b_967_965, kk_test_float_bench2__new_mlift782_f_fun1175(a00, _ctx), _ctx); /*1001*/
...
kk_unit_t kk_test_float_bench2__mlift783_f(kk_ref_t i, kk_unit_t wild__3, kk_context_t* _ctx) { /* forall<h> (i : local-var<h,int>, wild_3 : ()) -> <bra,count,div,local<h>> () */ 
  kk_integer_t x_820;
  kk_box_t _x1181 = (kk_ref_get(i,kk_context())); /*1000*/
  x_820 = kk_integer_unbox(_x1181); /*int*/
  if (kk_yielding(kk_context())) {
    kk_integer_drop(x_820, _ctx);
    kk_box_t _x1182 = kk_std_core_hnd_yield_extend(kk_test_float_bench2__new_mlift783_f_fun1183(_ctx), _ctx); /*1002*/
...
static kk_box_t kk_test_float_bench2_f_fun1190(kk_function_t _fself, kk_std_core_hnd__marker _b_987, kk_std_core_hnd__ev _b_988, kk_context_t* _ctx) {
  ...
  kk_integer_t _x1192;
  kk_box_t _x1193 = (kk_ref_get(loc,kk_context())); /*1000*/
  _x1192 = kk_integer_unbox(_x1193); /*int*/
  kk_integer_t _x1194;
  kk_box_t _x1195 = (kk_ref_get(loc0,kk_context())); /*1000*/
...
static kk_box_t kk_test_float_bench2_f_fun1206(kk_function_t _fself, kk_box_t _b_996, kk_context_t* _ctx) {
  ...
  if (kk_yielding(kk_context())) {
    kk_box_t _x1210 = kk_std_core_hnd_yield_extend(kk_test_float_bench2_new_f_fun1211(loc, loc0, _ctx), _ctx); /*1002*/
...
static kk_box_t kk_test_float_bench2_f_fun1215(kk_function_t _fself, kk_box_t _b_1004, kk_context_t* _ctx) {
  ...
  if (kk_yielding(kk_context())) {
    kk_box_t _x1219 = kk_std_core_hnd_yield_extend(kk_test_float_bench2_new_f_fun1220(loc, loc0, _ctx), _ctx); /*1002*/
...
static kk_box_t kk_test_float_bench2_f_fun1202(kk_function_t _fself, kk_context_t* _ctx) {
  ...
  kk_ref_dup(loc);
  kk_ref_dup(loc0);
  _x1205 = kk_test_float_bench2_new_f_fun1206(loc, loc0, _ctx); /*(1003) -> 1001 1004*/
  _x1204 = kk_std_core_hnd_clause_tail1(_x1205, _ctx); /*std/core/hnd/clause1<1003,1004,1005,1001,1002>*/
  kk_std_core_hnd__clause1 _x1214 = kk_std_core_hnd_clause_tail1(kk_test_float_bench2_new_f_fun1215(loc, loc0, _ctx), _ctx); /*std/core/hnd/clause1<1003,1004,1005,1001,1002>*/
...
static bool kk_test_float_bench2_f_fun1228(kk_function_t _fself, kk_context_t* _ctx) {
  ...
  kk_integer_t x1_833;
  kk_box_t _x1229 = (kk_ref_get(loc,kk_context())); /*1000*/
  x1_833 = kk_integer_unbox(_x1229); /*int*/
  if (kk_yielding(kk_context())) {
    kk_integer_drop(x1_833, _ctx);
    kk_box_t _x1230 = kk_std_core_hnd_yield_extend(kk_test_float_bench2_new_f_fun1231(_ctx), _ctx); /*1002*/
...
static kk_box_t kk_test_float_bench2_f_fun1238(kk_function_t _fself, kk_context_t* _ctx) {
  ...
  kk_box_t _x1241;
  {
    ...
    kk_std_core_hnd__clause0 _match_1088 = kk_test_float_bench2__select_brara(h, _ctx); /*std/core/hnd/clause0<(),test/float/bench2/.hnd-bra,187,188>*/;
    {
      ...
      _x1241 = kk_function_call(kk_box_t, (kk_function_t, kk_std_core_hnd__marker, kk_std_core_hnd__ev, kk_context_t*), _fun_unbox_x1014, (_fun_unbox_x1014, m0, ev_838, _ctx)); /*1006*/
    }
  }
...
static kk_unit_t kk_test_float_bench2_f_fun1236(kk_function_t _fself, kk_context_t* _ctx) {
  ...
  kk_box_t _x1237 = kk_std_core_hnd__open_at0(_b_1019_1017, kk_test_float_bench2_new_f_fun1238(_ctx), _ctx); /*1001*/
  kk_unit_unbox(_x1237);
  if (kk_yielding(kk_context())) {
    kk_box_t _x1244 = kk_std_core_hnd_yield_extend(kk_test_float_bench2_new_f_fun1245(loc, _ctx), _ctx); /*1002*/
...
static kk_box_t kk_test_float_bench2_f_fun1198(kk_function_t _fself, kk_context_t* _ctx) {
  ...
  kk_ref_dup(loc);
  kk_ref_dup(loc0);
  _x1201 = kk_test_float_bench2_new_f_fun1202(loc, loc0, _ctx); /*() -> 1002 1001*/
  _x1200 = kk_std_core_hnd__open_none0(_x1201, _ctx); /*1001*/
...
kk_integer_t kk_test_float_bench2_f(kk_context_t* _ctx) { /* () -> div int */ 
  ...
  kk_ref_dup(loc0);
  kk_ref_dup(loc1);
  _x1189 = kk_test_float_bench2_new_f_fun1190(loc, loc0, loc1, _ctx); /*(std/core/hnd/marker<1013,1014>, std/core/hnd/ev<1012>) -> 1013 1011*/
  _x1188 = kk_std_core_hnd__new_Clause0(_x1189, _ctx); /*std/core/hnd/clause0<1011,1012,1013,1014>*/
  ...
  kk_integer_t res0;
  kk_box_t _x1248 = kk_std_core_hnd_prompt_local_var(loc1, kk_integer_box(res1), _ctx); /*1002*/
  res0 = kk_integer_unbox(_x1248); /*int*/
  kk_integer_t res;
  kk_box_t _x1249 = kk_std_core_hnd_prompt_local_var(loc0, kk_integer_box(res0), _ctx); /*1002*/
  res = kk_integer_unbox(_x1249); /*int*/
  kk_box_t _x1250 = kk_std_core_hnd_prompt_local_var(loc, kk_integer_box(res), _ctx); /*1002*/
