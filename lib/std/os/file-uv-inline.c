...
static void kk_std_os_fs_unit_cb(uv_fs_t* req) {
  ...
  if (result < 0) {
    ...
    kk_function_call(void, (kk_function_t, kk_std_core_exn__error, kk_context_t*), callback, (callback, kk_std_core_exn__new_Ok(kk_unit_box(kk_Unit), _ctx), _ctx), _ctx);
  }
}
...
static void kk_std_os_fs_write_cb(uv_fs_t* req) {
  ...
  if (result < 0) {
    ...
    kk_function_call(void, (kk_function_t, kk_std_core_exn__error, kk_context_t*), callback, (callback, kk_std_core_exn__new_Ok(kk_integer_box(kk_integer_from_ssize_t(result, _ctx), _ctx), _ctx), _ctx), _ctx);
  }
}
...
static kk_std_core_exn__error kk_uv_fs_write_sync(kk_std_os_file_dash_uv__uv_file file, kk_bytes_t bytes, int64_t offset, kk_context_t* _ctx) {
  ...
  if (result < 0) {
    ...
    return kk_std_core_exn__new_Ok(kk_integer_box(kk_integer_from_int64(result, _ctx), _ctx), _ctx);
  }
}
...
static void kk_std_os_fs_mkdtemp_cb(uv_fs_t* req) {
  ...
  if (result < 0) {
    ...
    uv_fs_req_cleanup(req);
    kk_function_call(void, (kk_function_t, kk_std_core_exn__error, kk_context_t*), callback, (callback, kk_std_core_exn__new_Ok(kk_string_box(str), _ctx), _ctx), _ctx);
  }
}
...
static kk_std_core_exn__error kk_uv_fs_mkdtemp_sync(kk_string_t tpl, kk_context_t* _ctx) {
  ...
  if (status < 0) {
    ...
    return kk_std_core_exn__new_Ok(kk_string_box(str), _ctx);
  }
}
...
void kk_std_os_fs_readdir_cb(uv_fs_t* req) {
  ...
  if (result < 0) {
    ...
    kk_free(uvdir->dirents, _ctx);
    kk_function_call(void, (kk_function_t, kk_std_core_exn__error, kk_context_t*), callback, (callback, kk_std_core_exn__new_Ok(kk_vector_box(dirents, _ctx), _ctx), _ctx), _ctx);
  }
}
...
static kk_std_core_exn__error kk_uv_fs_scandir_next(kk_std_os_file_dash_uv__uv_fs_req req, kk_context_t* _ctx) {
  ...
  if (status < 0) {
    ...
    return kk_std_core_exn__new_Ok(dirent, _ctx);
  }
}
...
static void kk_std_os_fs_stat_cb(uv_fs_t* req) {
  ...
  if (result < 0) {
    ...
    kk_function_call(void, (kk_function_t, kk_std_core_exn__error, kk_context_t*), callback, (callback, kk_std_core_exn__new_Ok(s, _ctx), _ctx), _ctx);
  }
}
...
static kk_std_core_exn__error kk_uv_fs_stat_sync(kk_string_t path, kk_context_t* _ctx) {
  ...
  if (status < 0) {
    ...
    return kk_std_core_exn__new_Ok(s, _ctx);
  }
}
...
static void kk_std_os_fs_int_cb(uv_fs_t* req) {
  ...
  if (result < 0) {
    ...
    kk_function_call(void, (kk_function_t, kk_std_core_exn__error, kk_context_t*), callback, (callback, kk_std_core_exn__new_Ok(kk_integer_box(kk_integer_from_int64(result, _ctx), _ctx), _ctx), _ctx), _ctx);
  }
}
...
static kk_std_core_exn__error kk_uv_fs_sendfile_sync(kk_std_os_file_dash_uv__uv_file out_fd, kk_std_os_file_dash_uv__uv_file in_fd, int64_t in_offset, kk_ssize_t length, kk_context_t* _ctx) {
  ...
  if (status < 0) {
    ...
    return kk_std_core_exn__new_Ok(kk_integer_box(kk_integer_from_int64(fs_req.result, _ctx), _ctx), _ctx);
  }
}
...
void kk_std_os_fs_string_cb(uv_fs_t* req) {
  ...
  if (result < 0) {
    ...
    kk_function_call(void, (kk_function_t, kk_std_core_exn__error, kk_context_t*), callback, (callback, kk_std_core_exn__new_Ok(kk_string_box(s), _ctx), _ctx), _ctx);
  }
}
...
static kk_std_core_exn__error kk_uv_fs_readlink_sync(kk_string_t path, kk_context_t* _ctx) {
  ...
  if (status < 0) {
    ...
    return kk_std_core_exn__new_Ok(kk_string_box(s), _ctx);
  }
}
