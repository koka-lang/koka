...
function _new_skip_frame(skip) {
  return new Handler("<skip>",id,[],undefined,skip,_handler_kind._Skip);
}
...
function _new_handlerx( effect_name, return_fun, branches0, handler_kind, handler_tag, wrap_handler_tag)
{
  ...
  const shared_handler = new Handler(effect_name, return_fun, branches, handler_kind, handler_tag);
