...
const bigInt = (function (undefined) {
    ...
    BigInteger.prototype.mul_pow10 = function(n) {
        ...
        n = +n;
        if (n===0) return this;
        if (n < 0) return this.div_pow10(-n);
        var large = n / LOG_BASE;
        var small = n % LOG_BASE;        
        var a = (small===0 ? this.value : multiplySmall(this.value,Math.pow(10,small)));
        while(--large >= 0) { a.unshift(0); }
        return new BigInteger( a, this.sign );   
    }
    SmallInteger.prototype.mul_pow10 = function(n) {
        ...
        if (n===0) return this;
        if (n < 0) return this.div_pow10(-n);
        return this.multiply(Math.pow(10,n));
    }
    ...
    BigInteger.prototype.div_pow10 = function(n) {
        ...
        n = +n;
        if (n===0) return this;
        if (n < 0) return this.mul_pow10(-n);
        var large = n / LOG_BASE;
        var small = n % LOG_BASE;        
        var a = this.value.slice(large); // shift out the lower digits
        var b = (small===0 ? a : divModSmall(a,Math.pow(10,small))[0] );
        return new BigInteger( b, this.sign );   
    }
    SmallInteger.prototype.div_pow10 = function(n) {
        ...
        if (n===0) return this;
        if (n < 0) return this.mul_pow10(-n);
        return this.divide(Math.pow(10,n));
    }
