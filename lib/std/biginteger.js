...
const bigInt = (function (undefined) {
    ...
    BigInteger.prototype.mul_pow10 = function(n) {
        ...
        var large = Math.trunc(n / LOG_BASE);
        var small = n - LOG_BASE*large;        
    ...
    BigInteger.prototype.div_pow10 = function(n) {
        ...
        var x   = (large===0 ? this : new BigInteger( this.value.slice(large), this.sign )); // shift out the lower digits
