...
if (typeof process !== 'undefined' && typeof process.hrtime === 'function') {
  ...
  _ticks = function() {
    ...
    return $std_core_types._Tuple2_(t[0], t[1] * _ticks_resolution); // to seconds
  }
}
  ...
  _ticks = function() {
    ...
    return $std_core_types._Tuple2_(secs, 0.0);
  };
}
else {
  ...
  _ticks = function() {
    ...
    _ticks_last = t;
    return $std_core_types._Tuple2_( (t + _ticks_delta) * _ticks_resolution, 0.0); 
  };
}
