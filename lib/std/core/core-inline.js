...
export function _int32_shr(x,y) {
  if (y <= 0)  return x;
  if (y >= 32) return 0;
  return ((x >>> y)|0);
}

export function _int32_sar(x,y) {
  if (y <= 0)  return x;
  if (y >= 32) return (x < 0 ? (-1)|0 : 0);
  return ((x >> y)|0);  
}

export function _int32_shl(x,y) {
  if (y <= 0)  return x;
  if (y >= 32) return 0;
  return ((x << y)|0);  
}
...
export function _int64_shr(x,y) {
  ...
  if (y >= 64n) return 0n;
  if (x >= 0n)  return (x >> y);
  var i = 0x10000000000000000n | x;  // set highest bit
  return ((i >> y) ^ (0x10000000000000000n >> y)); // shift and clear
}

export function _int64_sar(x,y) {
  if (y <= 0n)  return x;
  if (y >= 64n) return (x < 0n ? -1n : 0n);
  return (x >> y);  
}
