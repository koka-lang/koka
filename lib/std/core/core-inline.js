...
export function _int_to_int32(x) {
...
export function _int_to_byte(x) {
  const v = (_is_small(x) ? x : x.toJSNumber());
  if (v > 255) return 255;
  if (v < 0) return 0;
  return (v|0);
...
function _big_divmod(x,y) {
  ...
  return $std_core_types._Tuple2_(_unbig(q),_unbig(r));
}
...
export function _int_cdivmod(x,y) {
  ...
  if (!isNaN(q)) {
    ...
    return $std_core_types._Tuple2_(_unbig(qr.quotient),_unbig(qr.remainder));
  }
}
...
export function _int_compare(x,y) {
  ...
  if (!isNaN(d)) {
    ...
    return (c>0 ? $std_core_types.Gt : (c<0 ? $std_core_types.Lt : $std_core_types.Eq));
  }
}

export function _int_sign(x) {
  if (!isNaN(x)) {
    return (x>0 ? $std_core_types.Gt : (x<0 ? $std_core_types.Lt : $std_core_types.Eq));
  }
  else {
    return (x.isZero() ? $std_core_types.Eq : (x.isPositive() ? $std_core_types.Gt : $std_core_types.Lt));
  }
}

export function _int_eq(x,y)   { return _int_compare(x,y)===$std_core_types.Eq; }
export function _int_ne(x,y)   { return _int_compare(x,y)!==$std_core_types.Eq; }
export function _int_lt(x,y)   { return _int_compare(x,y)===$std_core_types.Lt; }
export function _int_le(x,y)   { return _int_compare(x,y)!==$std_core_types.Gt; }
export function _int_gt(x,y)   { return _int_compare(x,y)===$std_core_types.Gt; }
export function _int_ge(x,y)   { return _int_compare(x,y)!==$std_core_types.Lt; }
...
function _int_parse(s,hex) {
  ...
  else if (hex) return $std_core_types.Just(_unbig(bigInt(sign + sdigits,16)));
  else return $std_core_types.Just(bigInt(sign + sdigits));
}
