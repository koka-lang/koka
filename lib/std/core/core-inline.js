...
function _int_eq(x,y)   { return _int_compare(x,y)===$std_core_types.Eq; }
function _int_ne(x,y)   { return _int_compare(x,y)!==$std_core_types.Eq; }
function _int_lt(x,y)   { return _int_compare(x,y)===$std_core_types.Lt; }
function _int_le(x,y)   { return _int_compare(x,y)!==$std_core_types.Gt; }
function _int_gt(x,y)   { return _int_compare(x,y)===$std_core_types.Gt; }
function _int_ge(x,y)   { return _int_compare(x,y)!==$std_core_types.Lt; }
