...
kk_integer_t kk_slice_count( struct kk_std_core_string_Sslice sslice, kk_context_t* ctx );
kk_string_t  kk_slice_to_string( struct kk_std_core_string_Sslice sslice, kk_context_t* ctx );
struct kk_std_core_string_Sslice kk_slice_first( kk_string_t str, kk_context_t* ctx );
struct kk_std_core_string_Sslice kk_slice_last( kk_string_t str, kk_context_t* ctx );

struct kk_std_core_string_Sslice kk_slice_common_prefix_borrow( kk_string_t str1, kk_string_t str2, kk_integer_t upto, kk_context_t* ctx );
