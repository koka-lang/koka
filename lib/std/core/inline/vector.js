...
// Assign to a local array variable
// TODO: we can avoid a copy if we copy at the local reference creation?
export function kk_ref_vector_assign_borrow(ref,idx,val) {
