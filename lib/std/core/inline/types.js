...
export function kk_ref_new( x ) {
  return { value: x }
}

export function kk_ref_set( ref, x ) {
  ref.value = x
}

export function kk_ref_get( ref ) {
  return ref.value;
}

export function kk_ref_swap( ref, x ) {
  var old = ref.value
  ref.value = x
  return old
}
...
export function _int64_hi(x) {
  return (Number( (x>>32n) & 0xFFFFFFFFn ) | 0);
}

export function _int64_lo(x) {
...
export function _int64_as_uint64(x) {
  return (x < 0 ? x + 0x10000000000000000n : x);
}

export function _uint64_as_int64(x) {
  return (x >= 0x8000000000000000n ? x - 0x10000000000000000n : x);
}
...
export function _int32_as_uint32(x) {
  return (x < 0 ? x + 0x100000000 : x);
}

export function _uint32_as_int32(x) {
...
export function _uint_clamp8(x) {
...
export function _int_clamp32(x) {
  const v = _int_to_number(x);
  // console.log("int_clamp32: " + x + ": " + typeof x + " ->" + v)
...
export function kk_unsupported_external(fname) {
  throw(new Error("unsupported external: " + fname));
}