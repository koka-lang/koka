...
function _file_download_text(urlstr, timeout, cb) {
  var cbfun = $std_core._async_callback_err1(cb);
  var t = null;
  var timedOut = false;
...
function _download_text(urlstr, timeout, cb, redirected) {
  var progress = 5000; // some response every 2 seconds
  var req = null;
  var t   = null;
  ...
  var prot = (opts.protocol == "http:" ? http : https);
  opts.headers = { connection: "keep-alive" };
  req = prot.get(opts, function(response) {
